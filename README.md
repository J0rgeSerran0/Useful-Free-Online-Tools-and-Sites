...
- [**Nutilz - Compound Interest Calculator** - (*Project balance growth over time with configurable compounding frequency and optional monthly contributions — see a year-by-year breakdown of principal, deposits, and interest earned. Free, no signup*)](https://nutilz.com/compound-interest)
- [**Nutilz - DCA Calculator** - (*Track dollar cost averaging purchases in any stock, ETF, or cryptocurrency — enter each buy and the current price to see average cost per share, total shares owned, portfolio value, and ROI instantly. Free, no signup*)](https://nutilz.com/dca-calculator)
...
- [**Nutilz - Sleep Debt Calculator** - (*Calculate accumulated sleep debt from the past 7 nights — enter hours slept each night against your target to see daily deficits, total hours owed, severity rating, and a recovery timeline. Free, browser-only, no signup*)](https://nutilz.com/sleep-debt-calculator)
...
- [**Icons0** - (*The fastest icon search - for you and your AI agent*)](https://icons0.dev/)
...
- [**ImageClipboard** - (*Discord Emoji, Sticker & GIF Clipboard*)](https://www.imageclipboard.xyz/)
...
- [**GitHub Star History** - (*Compare GitHub Projects by stars*)](https://www.star-history.com/)
...
- [**Background Noise Remover** - (*Remove background noise & enhance your voice: any video or audio*)](https://www.waves.com/voice-regen)
...
- [**Chord Progression Generator** - (*Create musically intelligent chord progressions*)](https://liotier.github.io/AkaiMPC/AkaiMPCChordProgressionGenerator/)
...
- [**Nutilz QR Code Scanner** - (*Scan and decode QR codes from an uploaded image or live webcam, entirely in your browser — reads URLs, WiFi, vCards and text, no upload required*)](https://nutilz.com/qr-scanner)
...
- [**GitHub DMCA takedown** - (*DMCA takedown notices as received*)](https://github.com/github/dmca)
...
- [finaldynamics](https://github.com/finaldynamics)
...
- [JeremyGDM](https://github.com/JeremyGDM)
...
- [Winson Yang](https://github.com/ystyleb)
